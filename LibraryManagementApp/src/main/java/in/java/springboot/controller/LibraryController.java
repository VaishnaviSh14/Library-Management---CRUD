package in.java.springboot.controller;
...
import in.java.springboot.service.IBookService;
...
public class LibraryController {
   ...
   public String addNewBook(@ModelAttribute Book book, Model model) {
	...
	public String updateBook(@PathVariable Integer id, Model model, @ModelAttribute
	Book book) {
	service.findBookById(id).orElseThrow(() -> new
